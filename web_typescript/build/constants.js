...
export const CSS_CLASS_NAME_PLAYABLE = 'playable-';
...
export const CSS_CLASS_NAME_HIGHLIGHT_MOVE = 'highlight-move';
...
export const CSS_ELEMENT_ID_BOARD = 'board';
export const CSS_ELEMENT_ID_NEW_GAME_HVH = 'btnNewGameHumanVsHuman';
...
export const CSS_ELEMENT_ID_GAME_MESSAGE = 'game-message';
export const CSS_CLASS_NAME_MOVES_CONTAINER = 'moves-container';
export const CSS_CLASS_BLACK_PIECE_COUNT = 'black-piece-count';
export const CSS_CLASS_WHITE_PIECE_COUNT = 'white-piece-count';
export const GAME_FINISH_MESSAGE_TIE = 'Tie Game!';
export const GAME_FINISH_MESSAGE_BLACK_WINS = 'Black Wins!';
export const GAME_FINISH_MESSAGE_WHITE_WINS = 'White Wins!';
export const GAME_FINISH_MESSAGE_YOU_WIN = 'You Win!';
export const GAME_FINISH_MESSAGE_YOU_LOSE = 'You Lose!';
